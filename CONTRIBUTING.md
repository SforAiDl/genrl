...
["good first issue"](https://github.com/SforAiDl/genrl/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
black .
# Run lint checking
flake8 genrl/ tests/ examples/ contrib/
...
```python
pytest --cov-report html --cov='./genrl/' --cov-config=.coveragerc
```
