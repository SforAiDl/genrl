...
class SerialVecEnv(VecEnv):
    ...
    def render(self, mode="human"):
        ...
        :param mode: Can either be 'human' or 'rgb_array'. Displays tiled images in 'human' \
...
def venv(env, n_envs, parallel=False):
    ...
    :param env: Gym environment to be vectorised
    :param n_envs: Number of environments
    :param parallel: True if we want environments to run parallely and subprocesses, \
False if we want environments to run serially one after the other
